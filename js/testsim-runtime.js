(function(){
  ...
  var VERSIONED_ASSETS=[
    'css/styles.css','js/data.js','js/schedule.js','js/appearance.js','js/dashboard.js',
    'js/editor-backup.js','js/editor-core.js','js/editor-teachers.js','js/editor-schedule.js',
    'js/dashboard-render.js','js/gemini-ocr.js','js/testsim-runtime.js'
  ];
  ...
  function getAppVersion(){
    ...
    try {
      ...
      source=fetchTextSync(url);
      VERSIONED_ASSETS.forEach(function(asset){ source+=fetchTextSync(asset); });
    } catch (error) {
      source=ORBIT_INITIAL_MARKUP;
    }
  ...
  function syncAppVersion(){
    ...
    if (version) version.textContent='版本 '+getAppVersion();
  }
